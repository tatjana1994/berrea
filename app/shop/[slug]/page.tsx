  ...
  return (
    <main className='mt-20 bg-white'>
      <div className='mx-auto max-w-[1280px] px-6 py-20'>
        <Link
          href='/shop'
          className='inline-flex items-center gap-2 text-xs uppercase tracking-[0.18em] text-[#2A2A2A]/70 transition hover:text-[#1C1C1C]'
        >
          ← Back to shop
        </Link>
        ...
        <div className='mt-10 grid grid-cols-1 gap-12 lg:grid-cols-2 lg:gap-16'>
          ...
          <div className='flex flex-col'>
            ...
            <h1 className='mt-5 font-[var(--font-heading)] text-4xl leading-tight text-[#1C1C1C] md:text-5xl'>
              {product.name}
            </h1>
            ...
            <div className='mt-10 flex flex-col gap-3 sm:flex-row'>
              ...
              <Link
                href='/shop'
                className='inline-flex w-full items-center justify-center rounded-full border border-[#1C1C1C]/20 px-8 py-4 text-xs uppercase tracking-[0.18em] text-[#1C1C1C] transition hover:bg-[#F9F6F2] sm:w-auto'
              >
                Continue shopping
              </Link>
            </div>
